...
{
    public class 更正公告Service : I更正公告Service
    {
        ...
        public 更正公告Service(IOptions<CrawlerOption> options, IHttpService httpService, DaoService dao, IAnalyzeService analyzeService)
        {
