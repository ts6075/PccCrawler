...
{
    public class 政府採購預告Service : I政府採購預告Service
    {
        ...
        public 政府採購預告Service(IOptions<CrawlerOption> options, IHttpService httpService, DaoService dao, IAnalyzeService analyzeService)
        {
